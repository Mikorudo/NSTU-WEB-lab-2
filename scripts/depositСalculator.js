...
const derpositeSizeInput = document.getElementById("derpositeSizeInput");
    ...
    depositTypeSelector.addEventListener("change", function () {
        ...
        switch (depositTypeSelector.value) {
            ...
            case "option2":  //Для срочного вклада
                ...
                break;
            default:
                alert("Ошибка в обработчике события depositTypeSelector -> change: неожиданный case");
                break;
        }
    });
    ...
    calculateButton.addEventListener("click", function () {
        ...
        switch (depositTypeSelector.value) {
            ...
            case "option2":
                ...
                break;
            default:
                alert("Ошибка в обработчике события calculateButtonSelector -> click -> switch (depositTypeSelector.value): неожиданный case");
        }
        ...
        switch (depositdurationSelector.value) {
            ...
            case "option2.6":
                ...
                break;
            default:
                alert("Ошибка в обработчике события calculateButtonSelector -> click -> switch (depositdurationSelector.value):"
                    + "неожиданный case");
                break;
        }
        let result = +derpositeSizeInput.value + derpositeSizeInput.value * duration * interestRate;
        let outputText = "При создании депозита типа " + depositType + " на сумму " + derpositeSizeInput.value
            + " на срок " + durationTxt + " позволит получить " + (interestRate * 100) + "% годовых. Итого по истечению срока вы получите " + result + ".";
